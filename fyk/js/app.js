...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const productPopups = document.querySelectorAll(".product-popup__media");
            productPopups.forEach((productPopup => {
                const mainImage = productPopup.querySelector(".product-popup__main-image");
                const thumbnails = productPopup.querySelectorAll(".product-popup__thumbnail");
                const gallery = productPopup.querySelector("[data-gallery]");
            ...
            if (galleryTwo) lightgallery_es5(galleryTwo, {
                plugins: [ lg_thumbnail_min ],
                licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
                speed: 400,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const closeButtons = document.querySelectorAll(".product-popup__close");
