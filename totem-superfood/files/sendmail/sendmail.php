...
$mail->Password   = 'Defender-240698';              //SMTP password
...
$interestsText .= isset($_POST['interest-smoothies']) ? 'Smoothies<br>' : '';
$interestsText .= isset($_POST['interest-kombucha']) ? 'Kombucha<br>' : '';
$interestsText .= isset($_POST['interest-fruit-infusion-drinks']) ? 'Fruit infusion drinks<br>' : '';
$interestsText .= isset($_POST['interest-liqberry']) ? 'LIQberry<br>' : '';

$body .= '<p><strong>Interested in:</strong><br>'
    . ($interestsText !== '' ? $interestsText : 'None')
    . '</p>';

$body .= '<p><strong>Additional information:</strong><br>' . nl2br($_POST['addInfo'] ?? '') . '</p>';
$body .= '<p><strong>Privacy policy consent:</strong> ' . (isset($_POST['agreement']) ? 'Ja' : 'Nein') . '</p>';
