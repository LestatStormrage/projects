(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-section__slider")) {
            ...
            new swiper_core_Swiper(".category__slider", {
    ...
    da.init();
    document.querySelectorAll(".category__slide").forEach((function(element) {
    ...
    document.querySelector(".TOS__content");
    ...
    TOSContainer.addEventListener("click", (e => {
        if (e.target === TOSContainer) TOSContainer.style.display = "none";
    }));
